/obj/pod/
	...
	proc/OpenHUD(var/mob/living/L)
		...
		if(H.restrained() || H.lying || H.stat || H.stunned || H.weakened)
			return 0
		...
		for(var/hardpoint in hardpoints)
			...
			var/obj/item/weapon/pod_attachment/attachment = GetAttachmentOnHardpoint(hardpoint)
			if(attachment)
	...
	Topic(href, href_list)
		...
		if(human.restrained() || human.lying || human.stat || human.stunned || human.weakened)
			return 0
