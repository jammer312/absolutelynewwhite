...
/obj/pod/large
	...
	pre_equipped/
		...
		GetArmor()
			return new /obj/item/weapon/pod_attachment/armor/light(src)
	...
	gold/
		...
		GetArmor()
			return new /obj/item/weapon/pod_attachment/armor/gold(src)
	...
	industrial/
		...
		GetAdditionalAttachments()
			return list(new /obj/item/weapon/pod_attachment/cargo/industrial(src))

		GetArmor()
			return new /obj/item/weapon/pod_attachment/armor/industrial(src)
	...
	prototype/
		...
		GetArmor()
			return new /obj/item/weapon/pod_attachment/armor/prototype(src)
	...
	precursor/
		...
		GetArmor()
			return new /obj/item/weapon/pod_attachment/armor/precursor(src)
...
/obj/pod/small
	...
	pre_equipped/
		...
		GetEngine()
			new /obj/item/weapon/pod_attachment/engine/plasma(src)
