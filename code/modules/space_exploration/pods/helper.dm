...
/obj/pod
	...
	proc/HasTraction()
		var/list/providers = list(/turf/simulated, /obj/structure/grille, /obj/structure/lattice)
	...
	proc/CanAttach(var/obj/item/weapon/pod_attachment/attachment)
	...
	proc/GetAdditionalAttachments()
		return list(new /obj/item/weapon/pod_attachment/cargo/small(src))
	...
	proc/GetAttachments()
		...
		for(var/obj/item/weapon/pod_attachment/attachment in contents)
