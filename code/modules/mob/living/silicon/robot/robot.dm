/mob/living/silicon/robot
	...
	maxHealth = 100
	health = 100
	macro_default = "borgmacro"
	macro_hotkeys = "borghotkeymode"
	bubble_icon = "robot"
	var/sight_mode = 0
	var/custom_name = ""
...
/mob/living/silicon/robot/proc/notify_ai(notifytype, oldname, newname)
	...
	switch(notifytype)
		if(1) //New Cyborg
			connected_ai << "<br><br><span class='notice'>NOTICE - New cyborg connection detected: <a href='?src=\ref[connected_ai];track=[rhtml_encode(name)]'>[name]</a></span><br>"
		if(2) //New Module
